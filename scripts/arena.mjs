...
try {
 ...
 else if(command==='engine-turn')value=await engineTurn(required('dir'),{enginePath:args['engine-path']===undefined?undefined:String(args['engine-path']),movetimeMs:int('movetime-ms',undefined),nodes:int('nodes',undefined),skillLevel:int('skill',undefined),timeoutMs:int('timeout-ms',undefined)});
